...
schema.statics.getDKCharacters = function(page, count) {
  if(!page) page = 1;
  if(!count) count = 20;
  return this.aggregate([
    {
      '$match': {
        'search_type': 'Donkey_Kong_characters'
      }
    }, {
      '$project': {
        '_id': true, 
...
schema.statics.getFzeroCharacters = function(page, count) {
  if(!page) page = 1;
  if(!count) count = 20;
  return this.aggregate([
    {
      '$match': {
        'search_type': 'F-Zero_pilots'
      }
    }, {
      '$project': {
        '_id': true, 
...
schema.statics.getSplatoonCharacters = function(page, count) {
  if(!page) page = 1;
  if(!count) count = 20;
  return this.aggregate([
    {
      '$match': {
        'search_type': 'Splatoon_characters'
      }
    }, {
      '$project': {
        '_id': true, 
...
schema.statics.getMotherCharacters = function(page, count) {
  if(!page) page = 1;
  if(!count) count = 20;
  return this.aggregate([
    {
      '$match': {
        'search_type': 'EarthBound_characters'
      }
    }, {
      '$project': {
        '_id': true, 
